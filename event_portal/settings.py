...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-*psdmhfc!$mxscn_l(b#n&r@edog!xb!8r#==w^w6!m0m40*l!')

DEBUG = config('DEBUG', default=False, cast=bool)

ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='127.0.0.1,.onrender.com', cast=Csv())
...
MIDDLEWARE = [
    ...
    # 'corsheaders.middleware.CorsMiddleware',  # Commented out for Vercel deployment
...
# CORS Settings (commented out for Vercel deployment)
